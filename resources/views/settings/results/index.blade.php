...
<div class="max-w-5xl mx-auto p-6">
  <div class="flex items-center justify-between mb-4">
    <h1 class="text-xl font-semibold">Results (Confirmation)</h1>
    <a class="btn btn-brand" href="{{ route('settings.results.create') }}">Add</a>
  </div>
      ...
      <tbody>
        @forelse($items as $i)
          <tr class="border-t border-slate-700/40">
            ...
            <td class="text-right">
              <a href="{{ route('settings.results.edit',$i) }}" class="text-blue-400 hover:underline">Edit</a>
              <form method="POST" action="{{ route('settings.results.destroy',$i) }}" class="inline"
